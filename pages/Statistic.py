...
describer.describe_sample(df, s_num_fields, s_cat_fields)
st.markdown('## SRBT intents and RT plans description:')
describer.describe_sample(df, p_num_fields, p_cat_fields)
st.markdown('## TNM staging distribution:')
describer.describe_sample(df, cat_fields = c_cat_fields)
st.markdown('## Outcomes description:')
describer.describe_outcomes(df)
st.markdown('## Estimations statistics:')
describer.estimations_stats(df)
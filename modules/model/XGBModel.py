...
class XGBModel:
    ...
    # params = {'objective': 'survival:aft', 'eval_metric': 'aft-nloglik', 'tree_method': 'auto', 'seed': 42, 'verbosity': 0, 'reg_alpha': np.float64(2.187962686617802), 'reg_lambda': np.float64(1.6147004880306643), 'min_child_weight': np.int64(18), 'max_depth': np.int64(3), 'learning_rate': 0.001, 'subsample': np.float64(0.8218558262776194), 'colsample_bytree': np.float64(0.7740592999973478), 'aft_loss_distribution': 'normal', 'aft_loss_distribution_scale': np.float64(0.5161991056664275)}
    params = {'objective': 'survival:aft', 'eval_metric': 'aft-nloglik', 'tree_method': 'auto', 'seed': 42, 'verbosity': 0, 'reg_alpha': np.float64(0.7973925078851283), 'reg_lambda': np.float64(0.5688463196840955), 'min_child_weight': np.int64(17), 'max_depth': np.int64(3), 'learning_rate': 0.001, 'subsample': np.float64(0.8485653900161997), 'colsample_bytree': np.float64(0.7544958648842105), 'aft_loss_distribution': 'normal', 'aft_loss_distribution_scale': np.float64(0.5321897572190253)}
